						...
						<div class="card-body style-default-bright table-responsive">
							<table class="table no-margin">
								...
								<tbody>
									...
									<tr>
										<td><?= $a ?></td>
										<td><?= $formBebass->formBebas_form_bebas ?></td>
										...
										<td>
											<a href="<?= base_url()."mhs/detailSyaratYudisium/".$formBebass->formBebas_id ?>"><button class="btn btn-primary btn-xs ink-reaction">Details</button></a>		
										</td>
									</tr>
									<?php $a++; } ?>
								</tbody>
